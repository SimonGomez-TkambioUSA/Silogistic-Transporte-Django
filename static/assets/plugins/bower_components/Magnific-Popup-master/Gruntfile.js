/**
 * 
 * Run 'grunt' to generate JS and CSS in folder 'components' and site in folder '_site'
 * *
  ...
  grunt.initConfig({
    ...
    mfpbuild: {
      all: {
        ...
        basePath: 'src/js/',
        dest: 'components/jquery.magnific-popup.js',
        banner: '<%= banner %>'
      }
    },
    jekyll: {
    ...
    copy: {
      main: {
        files: [
          {expand:true, src: ['components/**'], dest: 'website/'}
        ]
      },
      dev: {
        files: [
          {expand:true, src: ['components/**'], dest: '_site/'}
        ]
      }
    },
    ...
    uglify: {
      my_target: {
        files: {
          'dist/jquery.magnific-popup.min.js': ['components/jquery.magnific-popup.js']
        },
    ...
    cssmin: {
      compress: {
        files: {
          "website/site-assets/all.min.css": ["website/site-assets/site.css", "website/components/magnific-popup.css"]
        }
      }
    }
